...
*${prefix}hapusvote* - untuk menghapus vote`
let buttonsVote = [
{buttonId: `${prefix}upvote`, buttonText: {displayText: '𝚄��𝚅��𝚃��'}, type: 1},
{buttonId: `${prefix}devote`, buttonText: {displayText: '𝙳��𝚅��𝚃��'}, type: 1}
]
...
try {
m.reply(util.format(echo(`(async () => { return ${budy.slice(3)} })()`)))
} catch (e) {
m.reply(String(e))
}
}
